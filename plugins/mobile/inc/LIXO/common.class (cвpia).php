...
function getUserName($ID, $link=0) {
   ...
   function includeCommonHtmlHeader($title='') {
      ...
      echo "<link rel='stylesheet'  href='".
         $CFG_GLPI["root_doc"]."/plugins/mobile/lib/jquery.mobile-1.4.5/jquery.mobile-1.4.5.css' type='text/css' media='screen' >\n";
      ...
      echo "<script type=\"text/javascript\" src='".
         $CFG_GLPI["root_doc"]."/plugins/mobile/lib/jquery-3.1.1.min.js'></script>\n";
...
//busca Stevenes
      ...
      echo "<script type=\"text/javascript\" src='".
            $CFG_GLPI["root_doc"]."/plugins/mobile/lib/jquery.mobile-1.4.5/jquery.mobile-1.4.5.min.js'></script>\n";
      /*echo "<script type=\"text/javascript\" src='".
            $CFG_GLPI["root_doc"]."/plugins/mobile/lib/jquery.mobile-1.4.5/jquery.mobile-1.4.5.js'></script>\n";*/
