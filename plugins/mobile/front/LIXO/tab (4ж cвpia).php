...
function processing(){
	...
	//Processing	  
	echo '<div data-role="controlgroup" data-type="horizontal" style="float:none; text-align:center; margin-bottom:10px;">';
		//add followup	 
		//echo "<a href='followup.php?id=".$_REQUEST['id']."' data-role='button'>". __('Followup') ."</a>";
		echo "<a href='tab.php?glpi_tab=Ticket$1&id=".$_REQUEST['id']."&itemtype=Ticket&menu=maintain&ssmenu=ticket' data-role='button'>". __('Followup') ."</a>";
		
		//task	  
		echo "<a href='tab.php?glpi_tab=TicketTask$1&id=".$_REQUEST['id']."&itemtype=Ticket&menu=maintain&ssmenu=ticket' data-role='button'>". __('Task') ."</a>";
		
		//documents	  
		echo "<a href='tab.php?glpi_tab=Document_Item$1&id=".$_REQUEST['id']."&itemtype=Ticket&menu=maintain&ssmenu=ticket' data-role='button'>". __('Document') ."</a>";
		
		//add solution	  
		echo "<a href='tab.php?glpi_tab=Ticket$2&id=".$_REQUEST['id']."&itemtype=Ticket&menu=maintain&ssmenu=ticket' data-role='button'>". __('Solution') ."</a>";
	echo '</div>';
}
