...
### for using tx :
##tx set --execute --auto-local -r GLPI_webservices.glpi_webservices-version-140 'locales/<lang>.po' --source-lang en --source-file locales/glpi.pot
## tx push -s
## tx pull -a
