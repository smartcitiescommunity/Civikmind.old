...
$tabs = new PluginIframeDefaulttab;

if (isset($_POST["add"])) {
   $newID = $tabs->add($_POST);
   Html::redirect($CFG_GLPI["root_doc"]."/plugins/iframe/front/defaulttab.form.php");

} elseif (isset($_POST["delete"])) {
   $ok = $tabs->delete($_POST);
   Html::redirect($CFG_GLPI["root_doc"]."/plugins/iframe/front/defaulttab.php");
