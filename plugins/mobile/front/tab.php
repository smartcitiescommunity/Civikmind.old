...
function processing(){
	...
	//Processing	  
	echo '<div data-role="controlgroup" data-type="horizontal" data-mini="true" style="float:none; text-align:center;">';
		//add followup	 
		//echo "<a href='followup.php?id=".$_REQUEST['id']."' data-role='button'>". __('Followup') ."</a>";
		echo "<a href='tab.php?glpi_tab=Ticket$1&id=".$_REQUEST['id']."&itemtype=Ticket&menu=maintain&ssmenu=ticket' data-role='button' data-inline='true'>". __('Followup') ."</a>";
		
		//task	  
		echo "<a href='tab.php?glpi_tab=TicketTask$1&id=".$_REQUEST['id']."&itemtype=Ticket&menu=maintain&ssmenu=ticket' data-role='button' data-inline='true'>". __('Task') ."</a>";
		
		//documents	  
		echo "<a href='tab.php?glpi_tab=Document_Item$1&id=".$_REQUEST['id']."&itemtype=Ticket&menu=maintain&ssmenu=ticket' data-role='button' data-inline='true'>". __('Document') ."</a>";
		
		//add solution	  
		echo "<a href='tab.php?glpi_tab=Ticket$2&id=".$_REQUEST['id']."&itemtype=Ticket&menu=maintain&ssmenu=ticket' data-role='button' data-inline='true'>". __('Solution') ."</a>";
	echo '</div>';
}


if(strpos($_REQUEST['glpi_tab'],"main") == true &&  $_REQUEST['itemtype'] == "Ticket") {
	
	//echo "<a href='http://10.20.15.160/glpi911/plugins/mobile/front/item.php?itemtype=Ticket&menu=maintain&ssmenu=ticket&id=45634' data-role='button'>". __('Solution') ."</a>";	
	
	echo "<script>\n";
	echo "
	function goTicket() {
		location.href='item.php?itemtype=Ticket&menu=maintain&ssmenu=ticket&id=". $_REQUEST['id'] ."';
	}
...
if($_REQUEST['glpi_tab'] == "Ticket$1" &&  $_REQUEST['itemtype'] == "Ticket") {	

	global $DB;
	
	processing();
	
	echo "<a href='followup.php?id=".$_REQUEST['id']."' data-role='button'>". __('New followup') ."</a>";
	...
	while($row = $DB->fetch_assoc($result_fup)) {
		...
		echo '<li class="ui-li ui-li-divider ui-btn ui-bar-b ui-btn-up-undefined" data-role="list-divider" role="heading">'. __('Date') .': '.$row['date'].'</li>';
		//echo '<li class="ui-li ui-li-static ui-body-c">'.$row['date'].'</li>';
		
		echo '<li class="ui-li ui-li-divider ui-btn ui-bar-b ui-btn-up-undefined" data-role="list-dividerx" role="heading"> '.$LANG['common'][37].': '. $row_autor['name'] ." ".$row_autor['sname'] .'</li>';
		//echo '<li class="ui-li ui-li-static ui-body-c">'. $row_autor['name'] ." ".$row_autor['sname'] .'</li>';
		
		echo '<li class="ui-li ui-li-divider ui-btn ui-bar-b ui-btn-up-undefined" data-role="list-divider" role="heading"> '. __('Description').': </li>';
...
/*		echo '<li class="ui-li ui-li-divider ui-btn ui-bar-b ui-btn-up-undefined" data-role="list-divider" role="heading">'.__('Task').': </li>';
		echo '<li class="ui-li ui-li-static ui-body-c">'. $row['content'] .'</li>';*/
		
		echo '<li class="ui-li ui-li-divider ui-btn ui-bar-b ui-btn-up-undefined" data-role="list-divider" role="heading"> '.__('Date').': </li>';
		echo '<li class="ui-li ui-li-static ui-body-c">'.$row['date'].'</li>';
		...
		echo '<li class="ui-li ui-li-divider ui-btn ui-bar-b ui-btn-up-undefined" data-role="list-divider" role="heading"> '. __('End') .': </li>';
...
if($_REQUEST['glpi_tab'] == "Item_Ticket$1") {
	...
	while($row_id = $DB->fetch_assoc($result_item)) {
			
		$sql_it = "SELECT id, entities_id, name, serial, otherserial
		FROM glpi_".strtolower($row_id['itemtype'])."s
		WHERE `id` = ". $row_id['items_id'] ." ";
		
		$result_it = $DB->query($sql_it) ; 
		$row = $DB->fetch_assoc($result_it);
			
		echo '<li class="ui-li ui-li-divider ui-btn ui-bar-b ui-btn-up-undefined" data-role="list-divider" role="heading">'.__('Type').':</li>';
		echo '<li class="ui-li ui-li-static ui-body-c">'. __($row_id['itemtype']).'</li>';
		
		echo '<li class="ui-li ui-li-divider ui-btn ui-bar-b ui-btn-up-undefined" data-role="list-divider" role="heading"> '.__('Name').': </li>';
		echo '<li class="ui-li ui-li-static ui-body-c">'.$row['name'].' ('.$row_id['items_id'].')</li>';
		
		echo '<li class="ui-li ui-li-divider ui-btn ui-bar-b ui-btn-up-undefined" data-role="list-divider" role="heading"> '.__('Serial number').': </li>';
		echo '<li class="ui-li ui-li-static ui-body-c">'.$row['serial'].'</li>';
		
		echo '<li class="ui-li ui-li-divider ui-btn ui-bar-b ui-btn-up-undefined" data-role="list-divider" role="heading"> '.__('Inventory number').': </li>';
		echo '<li class="ui-li ui-li-static ui-body-c">'.$row['otherserial'].'</li>';		
...
if($_REQUEST['glpi_tab'] == "Ticket$4") {
	
	global $DB;	
	
	$sql_dt = "SELECT date, time_to_own, due_date, solvedate, closedate, takeintoaccount_delay_stat, solve_delay_stat, close_delay_stat, waiting_duration
	FROM glpi_tickets
	WHERE `id` = ".$_REQUEST['id']."	";
			
	$result_dt = $DB->query($sql_dt);
	
	echo '<ul class="ui-listview" data-theme="c" data-role="listview">';
	
	while($row = $DB->fetch_assoc($result_dt)) {
...
/*		$sql_it = "SELECT id, entities_id, name, serial, otherserial
		...
		echo '<li class="ui-li ui-li-static ui-body-c">'. __($row['date']).'</li>';
		
		echo '<li class="ui-li ui-li-divider ui-btn ui-bar-b ui-btn-up-undefined" data-role="list-divider" role="heading"> '.__('Time to own').': </li>';
		echo '<li class="ui-li ui-li-static ui-body-c">'.$row['time_to_own'].'</li>';
		
		echo '<li class="ui-li ui-li-divider ui-btn ui-bar-b ui-btn-up-undefined" data-role="list-divider" role="heading"> '.__('Time to resolve').': </li>';
		...
		echo '<li class="ui-li ui-li-divider ui-btn ui-bar-b ui-btn-up-undefined" data-role="list-divider" role="heading"> '.__('Closing date').': </li>';
		echo '<li class="ui-li ui-li-static ui-body-c">'.$row['closedate'].'</li>';				

		echo '<li class="ui-li ui-li-divider ui-btn ui-bar-b ui-btn-up-undefined" data-role="list-divider" role="heading"> '.__('Take into account').': </li>';
		echo '<li class="ui-li ui-li-static ui-body-c">'.Html::timestampToString($row['takeintoaccount_delay_stat'],0).'</li>';
		
		echo '<li class="ui-li ui-li-divider ui-btn ui-bar-b ui-btn-up-undefined" data-role="list-divider" role="heading"> '.__('Resolution').': </li>';
		echo '<li class="ui-li ui-li-static ui-body-c">'.Html::timestampToString($row['solve_delay_stat'],0).'</li>';
		
		echo '<li class="ui-li ui-li-divider ui-btn ui-bar-b ui-btn-up-undefined" data-role="list-divider" role="heading"> '.__('Closure').': </li>';
		echo '<li class="ui-li ui-li-static ui-body-c">'. Html::timestampToString($row['close_delay_stat'],0).'</li>';
		
		echo '<li class="ui-li ui-li-divider ui-btn ui-bar-b ui-btn-up-undefined" data-role="list-divider" role="heading"> '.__('Pending').': </li>';
		echo '<li class="ui-li ui-li-static ui-body-c">'.Html::timestampToString($row['waiting_duration'],0).'</li>';
